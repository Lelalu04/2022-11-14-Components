...
function createFooter() {
    ...
    const footerImgDiv = createElement(`div`,"", `footer-decoration footer-container-wrapper`)
    const footerImg = createElement(`img`)
    footerImg.setAttribute(`src`, "https://codeacademy.lt/wp-content/themes/codeacademy/dist/images/footer.svg")
    ...
    a.setAttribute(`href`, "https://codeacademy.lt/")

    const img = createElement(`img`)
    img.setAttribute(`src`, "https://codeacademy.lt/wp-content/themes/codeacademy/dist/images/codeacademy-white.svg")

    const footerWidgets = createElement(`div`, "", "footer-widgets")
    
    const footerWidgetLeft = createElement(`div`, "", "footer-widget-left")
    const footerSectionLeft = footerSection(` <li class="meniu-choice"><a href="#">Studentams</a></li>
    <li class="meniu-choice"><a href="#">Jei galiu aš – gali ir tu!</a></li>
    <li class="meniu-choice"><a href="#">Verslui</a></li>
    <li class="meniu-choice"><a href="#">Programos</a></li>
    <li class="meniu-choice"><a href="#">Nemokamos Studijos</a></li>
    <li class="meniu-choice"><a href="#">UŽT kursai</a></li>
    <li class="meniu-choice"><a href="#">Programavimo kalbos</a></li>
    <li class="meniu-choice"><a href="#">Apie mus</a></li>
    <li class="meniu-choice"><a href="#">Naujienos</a></li>
    <li class="meniu-choice"><a href="#">ES parama</a></li>
    <li class="meniu-choice"><a href="#">Kontaktai</a></li>`)


    footerWidgetLeft.append(footerSectionLeft)
    
    const footerWidgetCenter = createElement(`div`, "", "footer-widget-center")
    
    const h2 = createElement(`h2`, "Vilnius")
    const footerSectionCenter = footerSection(`<li class="meniu-choice"><a href="#">Saulėtekio al. 15,
    Vilnius</a></li>
<li class="meniu-choice"><a href="#">Antakalnio g. 17,
    Vilnius</a></li>`)

    footerWidgetCenter.append(h2,footerSectionCenter)

    const footerWidgetRight = createElement(`div`, "", "footer-widget-right")

    const footerSectionRight = footerSection(`<li><a href="https://www.instagram.com/codeacademy.lt" class="instagram"
...
<li>
<a href="https://www.facebook.com/codeacademy.lt" class="facebook" title="Facebook"><svg
...
<li><a href="https://www.linkedin.com/school/codeacademy.lt/" class="linkedin"
    title="Linkedin"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
        <path
    ...
    footerWidgetRight.append(footerSectionRight)
    footerWidgets.append(footerWidgetLeft,footerWidgetCenter, footerWidgetRight)

    const footerInfo = createElement(`div`, "", "footer-info")
    const copyright = createElement(`div`, "©&nbsp;By UAB Programuok | CodeAcademy šeimos narys&nbsp;–&nbsp;", "copyright")
    const codeAcademyKids = createElement(`a`, `CodeAcademy Kids`)
    codeAcademyKids.setAttribute(`href`, "https://www.codeacademykids.com/bureliai/")

    const privacyPolicy = createElement(`div`, "", "privacy-policy")
    const privacyPolicyLink = createElement(`a`, `Privatumo politika`, `privacy-policy-link`)
    privacyPolicyLink.setAttribute(`href`, "#")

    privacyPolicy.append(privacyPolicyLink)
    copyright.append(codeAcademyKids)
    footerInfo.append(copyright,privacyPolicy)

    const footerCertificates = createElement(`div`, "", "footer-certificates")
    const footerCertificatesImg = createElement(`img`)
    footerCertificatesImg.setAttribute(`src`, "https://codeacademy.lt/wp-content/themes/codeacademy/dist/images/sertika.svg")

    footerCertificates.append(footerCertificatesImg)
    a.append(img)
    footerLogo.append(a)
    wrapper.append(footerLogo,footerWidgets,footerInfo,footerCertificates)
    footer.append(wrapper,footerImgDiv)
